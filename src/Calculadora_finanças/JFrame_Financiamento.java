package Calculadora_finanças;

public class JFrame_Financiamento extends javax.swing.JFrame {

    public JFrame_Financiamento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Valor Financiado", "Tx Juros a.a. (%)", "N° Prestações", "Valor Prestações", "Montante"
            }
        ) {
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        String mensagem = String.format("Prazo de %,d meses", menorPrazo);
        this.jTextField1.setText(mensagem);
        }
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        ...
        this.jTextField4.setText(mensagem);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_Financiamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_Financiamento().setVisible(true);
            }
        });
    }
